    ...
    if (mer >= 12 && mer < 24) {
      ...
      if (
        ...
        if (parseInt(alarm3.value) == mer) {
          ...
          chngImg.innerHTML =
            "<img src='./media/resize-1674823322740113724evening.jpg' alt='evening snacks'>";
        }
        if (parseInt(alarm4.value) == mer) {
          msg2.innerText = "CLOSE YOUR EYES AND GO TO SLEEP";
          chngImg.innerHTML =
